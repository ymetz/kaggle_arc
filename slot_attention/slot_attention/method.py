...
class SlotAttentionMethod(pl.LightningModule):
    def __init__(self, model: SlotAttentionModel, datamodule, params: SlotAttentionParams):
        super().__init__()
        self.model = model
    ...
    def sample_images(self):
        dl = self.datamodule.validation_dataloader()
    ...
    def test_step(self, batch, batch_idx, optimizer_idx=0):
        test_loss = self.model.loss_function(batch)
        ...
        vutils.save_image(images, "test_outputs/output_"+str(batch_idx)+".png") 
